function addTwoEveryNumberInTheList(list){
    const newList= [];
...
function makeDogObject(){
    ...
    //has a speak method that return 'woof'
...
function getListOfNames(list){
    ...
    //{name: "Som Person", jobTitle: "Boss Person", age: 30}
    //return a list of all the worker's names
    let listNames = list.map((obj)=> obj.name)
    return listNames;
}

function getAverage(list){
    //using the same list as above,get the average age of all the workers
    let avg = list.reduce((accSum,currentPerson)=> accSum+currentPerson.age,0);
...
describe("addTwoToEveryNumberInTheList", function(){
    it("should add two to every number in a list - test case", function(){
        expect(addTwoEveryNumberInTheList([2,4,6,9,1])).toEqual([4,6,8,11,3]);
    });

    it("should add two to every number in a list -list of one", function(){
        expect(addTwoEveryNumberInTheList([1])).toEqual([3]);
    });
    it("should add two every number in a list -empty list", function(){
        expect(addTwoEveryNumberInTheList([])).toEqual([]);
    });
});
...
describe("makeDogObject", function(){
    ...
    describe("sort", function(){
        ...
        it("should sort a list of numbers, test reversed case",function(){
        ...
        it("should sort a list of numbers, test empty case",function(){
            const numbers = [];
